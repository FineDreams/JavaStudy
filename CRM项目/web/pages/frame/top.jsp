						...
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									<td width="51" valign="middle">
										<font color="#FFFFFF">
											欢迎您： <s:property value="#session.crmStaff.loginName"/>
										</font>
									</td>
								</tr>
							</table>
							...
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									<td width="51" valign="middle">
										...
										<td width="55" valign="middle"><a href="<s:url value="staff_logOut.action"/> " target="_top"><font color="ffffff">重新登录</font></a></td>
								</tr>
							</table>
						</div>
						</td>
