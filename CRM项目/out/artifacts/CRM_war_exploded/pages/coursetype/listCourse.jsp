...
<s:form action="course_searchGroup" method="post">
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>  
	    <td >总学时：</td>
	    <td ><s:textfield  name="totalStart" size="12" value="" />  至  <s:textfield name="totalEnd" size="12" value="" /></td>
	    <%--<td ><input type="text" name="totalStart" size="12" value="" />  至  <input type="text" name="totalEnd" size="12" value="" /></td>--%>
	  </tr>
	  <tr>
	    <td>课程费用：</td>
	    <td ><s:textfield name="lessonCostStart" size="12" value="" /> 至 <s:textfield name="lessonCostEnd" size="12" value="" /></td>
   ...
   <tr class="tabtd1">
	    ...
	    <td align="center"><s:property value="%{#course.courseCost}"/></td>
	  	<td width="11%" align="center">
			...
			<s:url action="course_queryCourseById" var="queryById">
				<s:param name="crmCourseType.courseTypeId" value="#course.courseTypeId"/>
			</s:url>
			<s:a href="%{#queryById}"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></s:a>
	  		<%--<a href="<s:url value="course_queryCourseById.action"><s:param name="courseTypeId" value="%{#course.courseTypeId}"/> </s:url> "><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></a>--%>
	  	</td>
	  </tr>
</s:iterator>
