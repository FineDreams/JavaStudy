        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/admin/AddAdmin" method="post" class="main_form">
                        ...
                        <div class="input_info_scroll">
                            <ul>
                                <c:forEach items="${roleList}" var="role" varStatus="status">
                                    <li><input name="roleIds" value="${role.roleId}" type="checkbox"/>${role.name}</li>
                                </c:forEach>
                    ...
                    <div class="button_info clearfix">
                        ...
                        <input type="button" value="取消" class="btn_save" onclick="location.href='${pageContext.request.contextPath}/admin/toAdmin'"/>
                    </div>
                </form>  
        </div>
        <!--主要区域结束-->
