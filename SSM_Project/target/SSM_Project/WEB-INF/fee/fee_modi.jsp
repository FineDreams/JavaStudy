...
<html>
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/feeModify" method="post" class="main_form" name="costModify">
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info"><input type="text" class="readonly" name="id" readonly value="${cost.id}" /></div>
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="cost_type" <c:if test="${cost.cost_type=='1'}">checked="checked"</c:if> value="1" id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="cost_type" <c:if test="${cost.cost_type=='2'}">checked="checked"</c:if> value="2" checked="checked" id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="cost_type" <c:if test="${cost.cost_type=='3'}">checked="checked"</c:if> value="3" id="timeBased" onclick="feeTypeChange(3);" />
