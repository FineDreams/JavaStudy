...
<div class="top" style="height: 90px;width: 100%">
    <ul class="ul1">
        ...
        <li  style="font-size: 34px;font-family: 金梅浪漫豆豆字體;margin:15px 5px 20px 5px">忘语</li>
    ...
    <ul class="ul2">
        ...
        <li class="font" style="margin: 30px 5px 30px 10px">
            ...
            <%--<y:if test="${session.getAttribute('uname')!=null}">--%>
                <a href="/user/index.jsp" style="text-decoration-line: none">不语首页</a>
            <%--</y:if>--%>
            <%--<y:if test="${session.getAttribute('uname')==null}">--%>
                <%--<a onclick="window.alert('请先登录!')" href="" style="text-decoration-line: none">不语首页</a>--%>
            <%--</y:if>--%>
...
<div class="top"style="height: 580px;width: 610px;float: right;margin: 100px 50px 100px 20px">
    ...
    <form action="/user/login.action" method="post">
        ...
        <input name="username" type="text" class="in" style="font-size: 20px;padding-left: 50px"
        ...
        <s:fielderror fieldName="UNameError"/>
