...
<html>
  ...
  <body class="easyui-layout">   
    <div data-options="region:'north',split:true" style="height:100px;">
        ...
        <span style="font-size: 25px;color: red;padding-top: 15px;padding-left: 50px">欢迎用户:<a href="#" style="text-decoration: none">袁营营</a> </span>
        <span style="font-size: 25px;color:red;padding-top: 15px;padding-left: 30px">身份:学生</span>
    </div>   
