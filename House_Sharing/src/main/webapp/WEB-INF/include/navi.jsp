...
<div id="navi">
    ...
    <%--<ul id="menu">--%>
        ...
        <%--<li><a href="../user/user_modi_pwd.jsp" class="password_<c:choose><c:when test='<%=request.getParameter("class").equals("password")%>'>on</c:when><c:otherwise>off</c:otherwise></c:choose>"></a></li>--%>
    <%--</ul>--%>
</div>
