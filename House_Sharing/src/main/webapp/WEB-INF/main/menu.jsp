    ...
    <ul id="menu">
        <%--<h1>${currentModule}</h1>--%>
            ...
            <c:if test="${sessionScope.power=='2'}">
                <%--<li><a href="${pageContext.request.contextPath}/login/toIndex" class="index_on"></a></li>--%>
                <li><a href="${pageContext.request.contextPath}/admin/queryAllUser" class="role_off"></a></li>
                <li><a href="${pageContext.request.contextPath}/admin/queryAllRentals" class="account_off"></a></li>
